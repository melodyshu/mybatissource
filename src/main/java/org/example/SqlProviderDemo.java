 ...
 * @Date: 2020-05-31
 */
public class SqlProviderDemo {

  public static void main(String[] args) throws Exception {
    SqlProviderDemo sqlProviderDemo=new SqlProviderDemo();
    sqlProviderDemo.testStatement();
  }
  ...
  public void testStatement() throws Exception {
    ...
    List<User> userList = userMapper.selectByName("李四");
